      ...
      <nav className="flex-1 overflow-y-auto px-6 space-y-10 py-4 custom-scrollbar">
        ...
        <div className="mt-auto pt-8 border-t border-slate-100">
          ...
          <div className="space-y-1">
            <Link href="/customers" className="flex items-center gap-3 px-4 py-2 text-xs font-bold text-slate-500 hover:text-blue-600 transition-colors">
              <Users className="w-4 h-4" /> Global CRM
            </Link>
            <Link href="/documents" className="flex items-center gap-3 px-4 py-2 text-xs font-bold text-slate-500 hover:text-blue-600 transition-colors">
